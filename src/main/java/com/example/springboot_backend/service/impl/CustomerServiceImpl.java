...
public class CustomerServiceImpl implements CustomerService{
	...
	public Customer saveCustomer(Customer customer) {
		...
		customer.setBank(bankRepository.getBankByName(customer.getBankName()));
...
public Customer updateCustomer(Customer customer, int id) {
	...
	existingCustomer.setBank(bankRepository.getBankByName(customer.getBankName()));//this customer parameter has a bank name because it was passed just now as a json object, the bank name from this entity is not deleted until its stored(its transient)
